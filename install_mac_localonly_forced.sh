...
URL="https://raw.githubusercontent.com/dniklewicz/UPSPowerHelper/master/src/upspowerHelper_localonly_forced.py"
...
echo "Starting forced power server on port $PORT"
